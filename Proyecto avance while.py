...
def lider_campeonato(piloto1, piloto2):
    if piloto1 > piloto2:
        return "Verstappen con ",piloto1
    elif piloto2 > piloto1:
        return "Hamilton con",piloto2
...
print("El lider del campeonato es ",lider_campeonato(ver_total, ham_total))
#Puntos por equipo
...
print("La diferencia al líder es de",diferencia_puntos_a_lider(ham_total), "puntos")
print("La diferencia al líder es de",diferencia_puntos_a_lider(ver_total), "puntos")
print("La diferencia al líder es de",diferencia_puntos_a_lider(nor_total), "puntos")
print("La diferencia al líder es de",diferencia_puntos_a_lider(bot_total), "puntos")
print("La diferencia al líder es de",diferencia_puntos_a_lider(per_total), "puntos")
print("La diferencia al líder es de",diferencia_puntos_a_lider(sai_total), "puntos")
print("La diferencia al líder es de",diferencia_puntos_a_lider(lec_total), "puntos")
print("La diferencia al líder es de",diferencia_puntos_a_lider(gas_total), "puntos")
print("La diferencia al líder es de",diferencia_puntos_a_lider(ric_total), "puntos")
print("La diferencia al líder es de",diferencia_puntos_a_lider(oco_total), "puntos")
print("La diferencia al líder es de",diferencia_puntos_a_lider(alo_total), "puntos")
print("La diferencia al líder es de",diferencia_puntos_a_lider(vet_total), "puntos")
print("La diferencia al líder es de",diferencia_puntos_a_lider(tsu_total), "puntos")
print("La diferencia al líder es de",diferencia_puntos_a_lider(strl_total), "puntos")
print("La diferencia al líder es de",diferencia_puntos_a_lider(lat_total), "puntos")
print("La diferencia al líder es de",diferencia_puntos_a_lider(rus_total), "puntos")
print("La diferencia al líder es de",diferencia_puntos_a_lider(rai_total), "puntos")
print("La diferencia al líder es de",diferencia_puntos_a_lider(gio_total), "puntos")
print("La diferencia al líder es de",diferencia_puntos_a_lider(msc_total), "puntos")
print("La diferencia al líder es de",diferencia_puntos_a_lider(maz_total), "puntos")